...
def main():
    ...
    for json_file in tqdm(json_list):
        ...
        try:
            ...
            img.save(join(output_dir, 'img', img_name), subsampling=-1)

            for data in label_data['result']['objects']:
                object_class = data['class_name']
                ...
                coord = data['annotation']['coord']
                x_min, y_min = int(coord['x']), int(coord['y'])
                width, height = int(coord['width']), int(coord['height'])
